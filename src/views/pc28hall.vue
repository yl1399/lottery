<template>
	<div class="hall">
		<div class="headtip">
			...
			<div class="drawing"><span>{{this.CountdownString_pc}}</span></div>
				...
				<ul class="outcome_content">
					...
					<li class="li_four">
						...
						<div class="confirm_btn4">
                            <input type="tel" placeholder="请输入彩钻" v-model="outcomeMoney4">
...
<script>
	...
	export default{
		...
		methods:{
			...
			GetOutcomeMsg()
			{
				//console.log("pc28 GetOutcomeMsg this.platform:"+this.platform);
				var data = {
			...
			{
				//console.log("pc28 GetWinningResultsMsg this.platform:"+this.platform);
				var data = {
				...
				if(!activeLi.length){
					...
					for(let i =0; i<activeLi.length;i++){
						...
						str += `<li>
									...
									<span>${span2_val}</span>
									<span>
										<input type="tel" value="${span3_val}" class="inputChange" >
									</span>
									<span class="delete_one"><i class="iconfont icon-cross"></i></span>
								</li>`
					}
        ...
        destroyed:function(){
		//	console.log("pc28 destroyed destroyed");
        	var that = this;
			...
			clearInterval(that.getHallTimer_pc);
